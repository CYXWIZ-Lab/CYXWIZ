...
src/
    ...
    gui/
        main_window.cpp   # Dockable main window
        node_editor.cpp   # Visual node editor (TODO: integrate ImNodes)
        console.cpp       # Command console
        viewport.cpp      # Training visualization
        properties.cpp    # Property panel
    scripting/
        python_engine.cpp # Embedded Python interpreter
        script_manager.cpp # Script management
    network/
...
- Style: Dark theme by default

**TODO Features** (marked in code):
- ImNodes integration for node editor
...
1. **ImNodes Integration** - Visual node editor in Engine
2. **ImPlot Integration** - Real-time training plots
...
7. **Authentication** - JWT tokens for gRPC
