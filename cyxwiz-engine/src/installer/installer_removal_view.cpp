...
bool RenderInstallerRemovalControl(
  ...
  if (ImGui::Button(ICON_FA_TRASH " Remove CyxWiz",
                    ImVec2(-1.0f, 34.0f))) {
  ...
  ImGui::TextColored(kDanger, "%s Remove this CyxWiz installation?",
  ...
  if (ImGui::Button("Remove permanently", ImVec2(175.0f, 36.0f))) {
    confirmed = true;
