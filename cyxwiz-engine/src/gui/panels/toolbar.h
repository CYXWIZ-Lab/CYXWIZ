...
private:
    ...
    std::filesystem::path backend_pack_runtime_root_;
    std::shared_ptr<runtime::BackendPackLifecycleService>
        backend_pack_lifecycle_service_;
    std::vector<BackendPackManagerRecord> backend_pack_catalog_records_;
