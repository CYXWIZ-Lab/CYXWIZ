    ...
    // Your First Model Tutorial
    {
        ...
        tutorial.steps = {
            ...
            },
            {
                "add_input",
                "Add an Input Layer",
                "First, we need an input layer to receive data. Right-click in CyxWiz Studio and select 'Data > DataInput' to add an input node.",
                "CyxWiz Studio",
