...
void NodeMetadataRegistry::InitializeDataSourceNodes() {
    ...
    RegisterNode({NodeType::DataSplit, NodeCategory::DataPipeline, "Data Split", ICON_FA_CODE_BRANCH,
        ...
        {{"Data", PinType::Tensor, true, "Legacy feature stream input; runtime roles resolve from registered datasets"},
         {"Labels", PinType::Labels, true, "Legacy labels input kept row-aligned with Data"}},
        {{"Train Data", PinType::Tensor, true, "Legacy compatibility pin; runtime consumes compiler-resolved Train partition"},
         {"Train Labels", PinType::Labels, false, "Legacy compatibility labels pin for saved graphs"},
         {"Val Data", PinType::Tensor, false, "Legacy compatibility pin; validation uses resolved dataset partitions"},
         {"Val Labels", PinType::Labels, false, "Legacy compatibility labels pin for validation graphs"},
         {"Test Data", PinType::Tensor, false, "Legacy compatibility pin; final test uses resolved dataset partitions"},
         {"Test Labels", PinType::Labels, false, "Legacy compatibility labels pin for held-out test graphs"}},
...
void NodeMetadataRegistry::InitializeAnalyticsNodes() {
    ...
    RegisterNode({NodeType::DecisionTreeClassifier, NodeCategory::Analytics, "Decision Tree", ICON_FA_SITEMAP,
        ...
        {{"target_col", "string", "", "Target label column", {}, ""},
         ...
         {"model_path", "string", "", "Optional JSON model artifact path", {}, ""},
...
void NodeMetadataRegistry::InitializeUtilityNodes() {
    ...
    RegisterNode({NodeType::TFIDFVectorizer, NodeCategory::TextProcessing, "TF-IDF", ICON_FA_ALIGN_LEFT,
        ...
        {{"text_col", "string", "", "Text column", {}, "Required string/large_string column to vectorize."},
         ...
         {"ngram_range", "dropdown", "1,1", "N-gram range", {"1,1", "1,2", "2,2"}, "Supported text features: unigrams, bigrams, or both. Bigrams can improve phrase-sensitive tasks but increase vocabulary planning cost."},
         {"ngram_min", "int", "1", "Min n-gram", {}, "Minimum n-gram size. Must be >= 1 and <= ngram_max."},
         {"ngram_max", "int", "1", "Max n-gram", {}, "Maximum n-gram size. Current engine support is up to 3."},
