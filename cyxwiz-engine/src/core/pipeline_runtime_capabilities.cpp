...
GetPipelineUnsupportedSequentialModelLayerCapabilities() {
    static const std::vector<PipelineUnsupportedTrainingNodeCapability> capabilities = {
        ...
        {gui::NodeType::Conv2D,
         "is not supported by ModelBuilder/SequentialModel; its native backend primitive and compiler sketch do not establish a production ArrayFire execution contract"},
        {gui::NodeType::Conv3D,
        ...
        {gui::NodeType::MaxPool2D,
         "has a backend primitive and compiler sketch but is not constructed by ModelBuilder/SequentialModel"},
        ...
        {gui::NodeType::GlobalAvgPool,
         "has a native backend primitive and compiler sketch but is not constructed by ModelBuilder/SequentialModel"},
