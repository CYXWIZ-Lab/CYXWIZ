...
int main() {
    ...
    Check(library.LoadPatternFromFile(WritePattern("guard_tensor_broadcast", "TensorBroadcastTo").string()),
    ...
    links.clear();
    Check(!library.InstantiatePatternWithCreator(
              "guard_tensor_broadcast", {}, nodes, links, next_node_id, next_link_id, ImVec2(0, 0), creator),
    ...
    Check(!library.InstantiatePattern(
              "guard_tensor_broadcast", {}, nodes, links, next_node_id, next_pin_id, next_link_id, ImVec2(0, 0)),
