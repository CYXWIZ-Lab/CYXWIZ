...
alpha is not yet owned by a production Module/optimizer update lifecycle and
the non-ArrayFire implementation supports shared alpha only. Locally
incompatible optional accelerators are device-selection skips.
