...
const std::vector<LegacyTensorDataOwner>& LegacyTensorDataInventory() {
    ...
    static const std::vector<LegacyTensorDataOwner> inventory = {
        ...
        {"cyxwiz-backend/src/algorithms/layers/gru.cpp", 21, "compatibility_compute", "GRU layer (+1 reviewed 2026-09-23: host handoff of the native provider's final hidden state, tofix68 P3)"},
        {"cyxwiz-backend/src/algorithms/layers/gru_backward.cpp", 7, "compatibility_compute", "GRU backward"},
        {"cyxwiz-backend/src/algorithms/layers/lstm.cpp", 36, "compatibility_compute", "LSTM layer (+1 reviewed 2026-09-23: host handoff of the native provider's final hidden state, tofix68 P2)"},
        ...
        {"cyxwiz-backend/src/algorithms/providers/nvidia_cublas_provider.cpp", 13, "transport_boundary", "NVIDIA neural provider host/device boundary copies (reviewed 2026-09-23: lstm/gru forward outputs + optional lstm final cell state + lstm/gru backward dx and four weight/bias gradients each, explicit v1 boundary copies)"},
