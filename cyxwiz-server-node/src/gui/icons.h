...
// Cloud/Download
#define ICON_FA_CLOUD_ARROW_DOWN    "\xef\x83\x80"  // U+F0ED - cloud download
...
#define ICON_FA_MOBILE_SCREEN       "\xef\x8f\x8f"  // U+F3CF - mobile screen
...
#define ICON_FA_TEMPERATURE_HIGH    "\xef\x9d\xa9"  // U+F769 - high temperature
...
#define ICON_FA_CIRCLE_USER         "\xef\x8a\xbd"  // U+F2BD - user circle
#define ICON_FA_USER_GEAR           "\xef\x93\xbe"  // U+F4FE - user with gear
#define ICON_FA_ID_CARD             "\xef\x8b\x82"  // U+F2C2 - id card
#define ICON_FA_SHIELD_HALVED       "\xef\x8f\xad"  // U+F3ED - shield halved
#define ICON_FA_ARROW_UP_RIGHT_FROM_SQUARE "\xef\x82\x8e"  // U+F08E - external link
...
#define ICON_FA_ENVELOPE            "\xef\x83\xa0"  // U+F0E0 - envelope/email
...
// Server Node specific icons
#define ICON_FA_BARS_PROGRESS       "\xef\xa0\xa8"  // U+F828 - progress bars
#define ICON_FA_ROCKET              "\xef\x84\xb5"  // U+F135 - rocket/deploy
#define ICON_FA_STORE               "\xef\x95\x8e"  // U+F54E - marketplace/store
#define ICON_FA_SCROLL              "\xef\x9c\x8e"  // U+F70E - logs/scroll
#define ICON_FA_CIRCLE_PLAY         "\xef\x85\x84"  // U+F144 - play circle
#define ICON_FA_PICKAXE             "\xef\x9c\x94"  // U+F714 - mining (using similar)
