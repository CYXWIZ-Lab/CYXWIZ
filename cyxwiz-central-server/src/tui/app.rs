...
/// Blockchain data for TUI display
#[derive(Debug, Clone)]
...
impl Default for BlockchainInfo {
    fn default() -> Self {
        Self {
            payer_pubkey: "Not connected".to_string(),
            balance_lamports: 0,
            program_id: "Not configured".to_string(),
            rpc_endpoint: "Not connected".to_string(),
...
impl App {
    pub fn new(
        ...
        Self {
            ...
            blockchain_info: BlockchainInfo::default(),
            nodes: Vec::new(),
            jobs: Vec::new(),
            payments: Vec::new(),
            logs: Vec::new(),
